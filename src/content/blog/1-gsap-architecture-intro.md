...
<figure class="prose-image">
  <img src="https://code-design-garden.b-cdn.net/gsap-logo.png" alt="Alt text" loading="lazy" decoding="async" />
  <!-- <figcaption>GSAP Logo</figcaption> -->
</figure>
...
GSAP has always been the OG tool for [awwwards](https://www.awwwards.com/) masters.
The concepts of timelines, tweens, and scroll triggers are simple to understand but require the meeting both visual imagination and coding expertise to make it happen.

Some really cool sites by creative developer-designers has opened the door of the GSAP wizards.



- [osmo.supply](https://www.osmo.supply/) for navigation, menu, galleries and many text and UI effects. They have a great course on use Barba.js with GSAP transitions.
- [made with gsap](https://madewithgsap.com/effects) crafts really dope motion and scroll effects in a tutorial format.
- [code grid](https://www.youtube.com/watch?v=t38bIJQqoB8&t=42s) reverse-engineers top **awwwards** sites and effects, a true OG. Also has a really affordable template library membership.
- [Annnimations](https://annnimate.com/), provides a component based library for motion effects. Great place for learning beginner to junior level basics, see their [learn page](https://annnimate.com/learn). [Great blog](https://lab.good-fella.com/blog) as well.
...
<figure class="prose-video" data-prose-video data-hls="https://vz-8dc492cd-3d0.b-cdn.net/0d34cce3-a324-4a5a-aff2-9450a28a12fd/playlist.m3u8">
