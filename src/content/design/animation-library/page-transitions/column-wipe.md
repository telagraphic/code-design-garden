---
title: "Column Wipe"
description: "Column Wipe."
slug: "page-transitions/column-wipe"
previewVideo: "column-wipe.mp4"
order: 49.885
published: true
categories: ["page-transition"]
triggers: ["load"]
libraries: ["vanilla-js"]
keywords: ["column", "wipe"]
sourceUrl: "https://www.osmo.supply/page-transition-course/column-wipe"
---
...
### Lesson notes
#### Links
- [GSAP Stagger Documentation](https://gsap.com/docs/v3/GSAP/Staggers/)
- [Fabric project by Dennis](https://fabric.codebydennis.com/)
#### What we're building
...
#### The choreography
1. Leave starts: columns move in from bottom, staggered
2. Old page is now hidden behind the columns
3. Enter starts: columns move out, revealing the new page
#### Gotchas
- Make sure your overlay has `pointer-events: none` when not animating, `pointer-events: auto` during transition
- Watch your z-index layering between overlay, old container, and new container
### Lesson code
```javascript
// -----------------------------------------
