...
slug: "page-transitions/transition-functions"
previewVideo: "transition-functions.mp4"
order: 49.869
published: true
categories: ["page-transition"]
triggers: ["load"]
libraries: ["vanilla-js"]
keywords: ["transition", "functions"]
sourceUrl: "https://www.osmo.supply/page-transition-course/transition-functions"
---
...
- `runPageOnceAnimation()` first page load, no previous page
- `runPageLeaveAnimation()` old page exits
- `runPageEnterAnimation()` new page enters
#### Once animation
